...
public class AngelConfig {
    ...
    public int passiveTickInterval() { return Math.max(10, c().getInt("performance.passive-tick-interval", 20)); }
    public int hudTickInterval() { return Math.max(10, c().getInt("performance.hud-tick-interval", 20)); }
    public int autosaveSeconds() { return Math.max(30, c().getInt("performance.autosave-seconds", 120)); }
